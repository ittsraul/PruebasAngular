// To parse this data:
//
//   import { Convert, Films } from "./file";
//
//   const films = Convert.toFilms(json);
//
...
export class Convert {
    public static toFilms(json: string): Films {
        return cast(JSON.parse(json), r("Films"));
    }

    public static filmsToJson(value: Films): string {
        return JSON.stringify(uncast(value, r("Films")), null, 2);
    }
}
