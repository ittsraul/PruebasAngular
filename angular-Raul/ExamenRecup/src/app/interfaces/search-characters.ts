// To parse this data:
//
//   import { Convert, SearchCharacters } from "./file";
//
//   const searchCharacters = Convert.toSearchCharacters(json);
//
...
export class Convert {
    public static toSearchCharacters(json: string): SearchCharacters {
        return cast(JSON.parse(json), r("SearchCharacters"));
    }

    public static searchCharactersToJson(value: SearchCharacters): string {
        return JSON.stringify(uncast(value, r("SearchCharacters")), null, 2);
    }
}
