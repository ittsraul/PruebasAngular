// To parse this data:
//
//   import { Convert, SearchFilms } from "./file";
//
//   const searchFilms = Convert.toSearchFilms(json);
//
...
export class Convert {
    public static toSearchFilms(json: string): SearchFilms {
        return cast(JSON.parse(json), r("SearchFilms"));
    }

    public static searchFilmsToJson(value: SearchFilms): string {
        return JSON.stringify(uncast(value, r("SearchFilms")), null, 2);
    }
}
